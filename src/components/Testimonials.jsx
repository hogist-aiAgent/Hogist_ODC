...
const testimonials = [
  {
    ...
    rating: 5,
    quote:
      'For the first time we came across someone from online who were very professional from taking the food order, specifying the tariff and dispatching the food delivery on time.',
    tags: [
  ...
  },
  {
    ...
    rating: 5,
    quote:
      'The coordination was seamless from order to delivery. Our team meals arrived hot, fresh, and exactly on schedule every single day of the event.',
    tags: [
      { icon: LocalShippingOutlinedIcon, label: 'On-Time Delivery' },
      { icon: RestaurantOutlinedIcon, label: 'Great Food Quality' },
      { icon: FavoriteBorderRoundedIcon, label: 'Reliable Service' },
  ...
  },
  {
    ...
    rating: 5,
    quote:
      'Hogist made catering our corporate event effortless. Packaging was neat, hygienic, and the whole team was easy to work with from start to finish.',
    tags: [
      { icon: LocalShippingOutlinedIcon, label: 'On-Time Delivery' },
      { icon: RestaurantOutlinedIcon, label: 'Great Food Quality' },
      { icon: FavoriteBorderRoundedIcon, label: 'Reliable Service' },
      ...
      >
          ...
          >
            ...
            <Box
              sx={{
                flex: { md: '0 0 54%' },
                position: 'relative',
                minHeight: { xs: 240, sm: 300, md: 'auto' },
              }}
            >
              <Box
                component="img"
        ...
        <Box
          sx={{
            ...
            overflow: 'hidden',
            boxShadow: '0 14px 34px rgba(20,10,10,0.08)',
            height:{md:120}
          }}
        >
          ...
          >
            ...
            <Stack
              direction="row"
              flexWrap="wrap"
              sx={{ columnGap: { xs: 3, sm: 4, md: 5 }, rowGap: 2, flex: 1 }}
            >
              {ratingCategories.map((cat) => {
                const Icon = cat.icon;
                return (
                  <Stack key={cat.label} alignItems="center" spacing={0.5}>
